...
info['pid_cam3'] = os.getpid()
UNIT = info['unit']
GPU_ID = info['gpu_id']
CAM_NUM = 3
OBJ_NAME = info['obj_name_cam3']
...
# THRESHOLD = 0.04513798
THRESHOLD = 0.15
MASK, BBOX = crop(MASK_CONFIG, 3)
...
class ad_models:
    def __init__(self):
        ...
        self.test_connect = pyjds.DeviceFactory.create(self.camera[0])
...
def image_preprocessing(image):
    ...
    template = cv2.imread('./template/b3.jpg', 0)
    template_top_left = (1276, 706)
